...
def ValidateSegmentation(args):
    ...
    if args.file_root == 'LIVER':
        args.file_root = 'D:\yanjiu\DGMA2-Net-main\LIVER'
...
if __name__ == '__main__':
    ...
    parser.add_argument('--file_root', default="LIVER", help='Data directory | LIVER | BCDD | CDTH | UAV-BCD')
    parser.add_argument('--inWidth', type=int, default=256, help='Width of RGB image')
    parser.add_argument('--inHeight', type=int, default=256, help='Height of RGB image')
    parser.add_argument('--num_workers', type=int, default=4, help='No. of parallel threads')
    parser.add_argument('--batch_size', type=int, default=1, help='Batch size')
    parser.add_argument('--vis_dir', default='D:\yanjiu\DGMA2-Net-main\logLIVER_iter_80000_lr_0.0005_YW\Vis', help='Directory to save the results')
    parser.add_argument('--onGPU', default=True, type=lambda x: (str(x).lower() == 'true'),
                        help='Run on CPU or GPU. If TRUE, then GPU.')
    parser.add_argument('--weight', default='D:\yanjiu\DGMA2-Net-main\log\LIVER_iter_40000_lr_0.0001\Epoch146_0.9114607512647106.pth', type=str, help='pretrained weight, can be a non-strict copy')
