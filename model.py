...
class DGMAANet(nn.Module):
    def __init__(self, input_nc, output_nc):
        ...
        # 定义RCEM模块
        # self.RCEM = RCEM([64, 128, 256, 512, 64, 128, 256, 512])
        #DAM1
        ...
        # self.DAM = DAM(out_d=[512, 256, 128, 64])
    ...
    def forward(self, x1, x2):
        ...
        # x1_2, x1_3, x1_4, x1_5, x2_2, x2_3, x2_4, x2_5 = self.RCEM(x1_1, x1_2, x1_3, x1_4, x1_5, x2_1, x2_2, x2_3, x2_4,
        #                                                            x2_5)
