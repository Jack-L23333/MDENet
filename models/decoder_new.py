...
class Decoder(nn.Module):
    ...
    # def forward(self, d5, d4, d3, d2):
        ...
        x1_5, x2_5 = self.DDEM1(x1_5, d5), self.DDEM1(x2_5, d5)
        x1_4, x2_4 = self.DDEM2(x1_4, d4), self.DDEM2(x2_4, d4)
        x1_3, x2_3 = self.DDEM3(x1_3, d3), self.DDEM3(x2_3, d3)
        x1_2, x2_2 = self.DDEM4(x1_2, d2), self.DDEM4(x2_2, d2)
